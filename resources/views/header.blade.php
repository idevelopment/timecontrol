        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url() }}">
                    <i class="glyphicon glyphicon-time"></i> {{ Config('timecontrol.title') }}
                </a>
            </div>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu fadeInUp animated">
                            ...
                            <li>
                                <a href="#">
                                    <span class="pull-left">
                                        <img src="" class="img-circle thumb-sm m-r-15" alt="img">
                                    </span>
                                    ...
                                    <span class="media-body block">
                                        New tasks needs to be done<br>
                            ...
                            <li>
                                <a href="#">
                                    <span class="pull-left">
                                        <img src="img/avatar-3.jpg" class="img-circle thumb-sm m-r-15" alt="img">
                                    </span>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="navbar-menu-item">
                                <div class="label">{{ Lang::get('aop.languages') }}</div>
                            </li>
    ...
    <div id="sidebar-wrapper" style="overflow:hidden">
        <div class="user-panel" style="background:#fff; padding-bottom:30px;">
            ...
            <div class="pull-left info">
                ...
                <a href="#">
                    <i class="fa fa-circle text-red"></i> Busy
                </a>
            </div>
        </div>
        <div id="main_menu" style="background:#fff;">
            <div class="panel-group" id="accordion">
                <div class="panel">
                    ...
                    <div id="collapseOne"
                         class="panel-collapse @if (Request::is('/*'))  collapsed @else collapse @endif">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#planning">
                                <span class="fa fa-folder"></span> Schedule & Tasks
                            </a>
                        </h4>
                    </div>
                    <div id="planning"
                         class="panel-collapse @if (Request::is('sick*'))  collapsed @else collapse @endif">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                @if(Auth::user()->is('Administrator'))
                                    <li class="nav-header">Configuration</li>
                                    <li class="@if (Request::is('types')) active @endif">
